...
const RegistrationPage: React.FC<RegistrPageProps> = observer(
  ({ onToggleRegist }) => {
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                {/* отображение ошибок при ригистраиции */}
                <div>
                  {store.loginError && (
                    <p style={{ color: "red" }}>{store.loginError}</p>
                  )}
                </div>
                {/* кнопка переадресация на новый компонент регистрации  */}
                <button onClick={onToggleRegist}>У меня есть аккаунт</button>
                <Button
